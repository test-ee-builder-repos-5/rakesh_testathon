...
```bash
ansible-builder build --file eee.yml --tag eee:latest --container-runtime podman
```
...
- **eee.yml**: This is your EE's "blueprint." It's the main definition file that ansible-builder will use to construct your image.
- **eee-template.yml**: This is the Ansible self-service automation portal template file that generated this. You can import it and use it as a base to create new templates for your portal.
...
```bash
# This command uses your 'eee.yml' file to build an image
# and tags it as 'eee:latest'
...
```bash
ansible-navigator run playbook.yaml --eei eee:latest --pull-policy missing
```
...
podman tag eee:latest your-pah-hostname/eee:latest

# Login to your Private Automation Hub
podman login your-pah-hostname

# Push the image
podman push your-pah-hostname/eee:latest
```
...
podman tag eee:latest your-internal-registry.com/eee:latest
podman login your-internal-registry.com
podman push your-internal-registry.com/eee:latest
```
...
If you want to reuse this execution environment template for future projects, you can import the generated **eee.yml** file into your self-service automation portal.
...
2. **Import from Git repository**: Enter the Git SCM URL containing your `eee.yml` file, click **Analyze** to validate, review the details, then click **Import**.
